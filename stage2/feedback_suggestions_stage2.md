...
======================================================================
GOLDEN SET EXPANSION RECOMMENDATIONS — STAGE2
======================================================================
...
Python Code to Add to stage2/evals.py CASES list:
...
Next Steps:
  1. Copy the cases above into stage2/evals.py CASES list
  2. Run: python3 stage2/evals.py --runs 1
